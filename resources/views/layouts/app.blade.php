    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-dark shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" style="padding-left: 40%; color: white" href="{{ url('/') }}">
                    {{ __('Pic-X')}}
                </a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('manage.package.index') }}">
                                     {{ __('Package Management') }}
                                 </a>
                                    @endif
                                    @if (!Route::is('manage.vehicle.*'))
                                    <a class="dropdown-item" href="{{ route('manage.vehicle.index') }}">
